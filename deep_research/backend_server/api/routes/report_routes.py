...
from deep_research.backend_server.database.db_config import SessionLocal, User, hash_password, verify_password
from deep_research.backend_server.api.services.report_service import ReportService
...
async def download_report(file_name: str):
    ...
    # If service returns a FileResponse
    if isinstance(file_response, FileResponse):
        return file_response

    # If file not found → return clean JSON error
    return JSONResponse(
        status_code=404,
